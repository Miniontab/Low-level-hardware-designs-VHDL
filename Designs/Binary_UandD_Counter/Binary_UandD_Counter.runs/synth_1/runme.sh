...
HD_PWD='C:/Users/tabby/Documents/VHDL/Designs/Binary_UandD_Counter/Binary_UandD_Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BinaryUDCounter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BinaryUDCounter.tcl
